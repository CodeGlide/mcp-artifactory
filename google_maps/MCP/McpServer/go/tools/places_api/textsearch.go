...
func TextsearchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/maps/api/place/textsearch/json%s", cfg.BaseURL, queryString)
		...
		var result models.PlacesTextSearchResponse
...
func CreateTextsearchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_maps_api_place_textsearch_json",
		mcp.WithDescription(""),
