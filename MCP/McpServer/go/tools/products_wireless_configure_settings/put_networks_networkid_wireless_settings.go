...
func Put_networks_networkid_wireless_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/settings", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_wireless_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_settings",
		mcp.WithDescription("Update The Wireless Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_settingsHandler(cfg),
	}
}
