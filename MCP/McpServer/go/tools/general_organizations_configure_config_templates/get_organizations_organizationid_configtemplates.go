...
func Get_organizations_organizationid_configtemplatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/configTemplates", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_configtemplatesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_configTemplates",
		mcp.WithDescription("List The Configuration Templates For This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_configtemplatesHandler(cfg),
	}
}
