...
func Post_organizations_organizationid_configtemplatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_organizations_organizationid_configtemplatesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_configTemplates",
		mcp.WithDescription("Create A New Configuration Template"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_configtemplatesHandler(cfg),
	}
}
