...
func Get_devices_serial_lldpcdpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/lldpCdp", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_lldpcdpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_lldpCdp",
		mcp.WithDescription("List LLDP and CDP information for a device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_lldpcdpHandler(cfg),
	}
}
