...
func Put_networks_networkid_wireless_ssids_number_vpnHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/ssids/%s/vpn", cfg.BaseURL, networkId, number)
...
func CreatePut_networks_networkid_wireless_ssids_number_vpnTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_ssids_number_vpn",
		mcp.WithDescription("Update The VPN Settings For The SSID"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_ssids_number_vpnHandler(cfg),
	}
}
