...
func Post_networks_networkid_appliance_trafficshaping_customperformanceclassesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_appliance_trafficshaping_customperformanceclassesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_appliance_trafficShaping_customPerformanceClasses",
		mcp.WithDescription("Add A Custom Performance Class For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_appliance_trafficshaping_customperformanceclassesHandler(cfg),
	}
}
