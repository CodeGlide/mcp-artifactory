...
func Get_organizations_organizationid_adminsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/admins", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_adminsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_admins",
		mcp.WithDescription("List The Dashboard Administrators In This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_adminsHandler(cfg),
	}
}
