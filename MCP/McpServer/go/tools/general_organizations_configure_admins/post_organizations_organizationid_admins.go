...
func Post_organizations_organizationid_adminsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_organizations_organizationid_adminsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_admins",
		mcp.WithDescription("Create A New Dashboard Administrator"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_adminsHandler(cfg),
	}
}
