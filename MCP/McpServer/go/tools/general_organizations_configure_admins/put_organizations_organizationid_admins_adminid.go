...
func Put_organizations_organizationid_admins_adminidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationid_admins_adminidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_admins_adminId",
		mcp.WithDescription("Update An Administrator"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_admins_adminidHandler(cfg),
	}
}
