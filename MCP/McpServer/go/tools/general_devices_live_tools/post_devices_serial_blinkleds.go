...
func Post_devices_serial_blinkledsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/blinkLeds", cfg.BaseURL, serial)
...
func CreatePost_devices_serial_blinkledsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_devices_serial_blinkLeds",
		mcp.WithDescription("Blink The LE Ds On A Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_devices_serial_blinkledsHandler(cfg),
	}
}
