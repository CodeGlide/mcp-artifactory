...
func Get_v1_teams_team_name_clients_client_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_clients_client_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_clients_client_id",
		mcp.WithDescription("Retrieve a Client"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_clients_client_idHandler(cfg),
	}
}
