...
func Delete_v1_teams_team_name_clients_client_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/clients/%s", cfg.BaseURL, team_name, client_id)
...
func CreateDelete_v1_teams_team_name_clients_client_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v1_teams_team_name_clients_client_id",
		mcp.WithDescription("Revoke access to a Client"),
		mcp.WithString("team_name", mcp.Required(), mcp.Description("(Required) The name of your Team")),
		mcp.WithString("client_id", mcp.Required(), mcp.Description("(Required) The UUID of a Client")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Delete_v1_teams_team_name_clients_client_idHandler(cfg),
	}
}
