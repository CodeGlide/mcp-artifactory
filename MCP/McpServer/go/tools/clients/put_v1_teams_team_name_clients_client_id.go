...
func Put_v1_teams_team_name_clients_client_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_clients_client_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_clients_client_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_clients_client_idHandler(cfg),
	}
}
