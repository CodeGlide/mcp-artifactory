...
func Delete_networks_networkidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s", cfg.BaseURL, networkId)
...
func CreateDelete_networks_networkidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_networks_networkId",
		mcp.WithDescription("Delete A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_networks_networkidHandler(cfg),
	}
}
