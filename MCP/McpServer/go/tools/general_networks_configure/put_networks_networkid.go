...
func Put_networks_networkidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId",
		mcp.WithDescription("Update A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkidHandler(cfg),
	}
}
