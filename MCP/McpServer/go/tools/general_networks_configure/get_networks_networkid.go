...
func Get_networks_networkidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId",
		mcp.WithDescription("Return A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkidHandler(cfg),
	}
}
