...
func Post_networks_networkid_bindHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/bind", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_bindTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_bind",
		mcp.WithDescription("Bind A Network To A Template"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_bindHandler(cfg),
	}
}
