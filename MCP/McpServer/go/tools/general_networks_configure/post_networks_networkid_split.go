...
func Post_networks_networkid_splitHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/split", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_splitTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_split",
		mcp.WithDescription("Split A Combined Network Into Individual Networks For Each Type Of Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_splitHandler(cfg),
	}
}
