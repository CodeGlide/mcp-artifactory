...
func Post_organizations_organizationid_insight_monitoredmediaserversHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/insight/monitoredMediaServers", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_insight_monitoredmediaserversTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_insight_monitoredMediaServers",
		mcp.WithDescription("Add A Media Server To Be Monitored For This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_insight_monitoredmediaserversHandler(cfg),
	}
}
