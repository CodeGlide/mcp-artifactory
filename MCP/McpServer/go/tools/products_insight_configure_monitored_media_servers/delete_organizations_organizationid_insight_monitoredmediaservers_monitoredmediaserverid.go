...
func Delete_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_organizations_organizationId_insight_monitoredMediaServers_monitoredMediaServerId",
		mcp.WithDescription("Delete A Monitored Media Server From This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridHandler(cfg),
	}
}
