...
func Get_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_insight_monitoredMediaServers_monitoredMediaServerId",
		mcp.WithDescription("Return A Monitored Media Server For This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_insight_monitoredmediaservers_monitoredmediaserveridHandler(cfg),
	}
}
