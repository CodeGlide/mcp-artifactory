...
func Get_networks_networkid_sm_users_userid_softwaresHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/users/%s/softwares", cfg.BaseURL, networkId, userId)
...
func CreateGet_networks_networkid_sm_users_userid_softwaresTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_users_userId_softwares",
		mcp.WithDescription("Get a list of softwares associated with a user"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_users_userid_softwaresHandler(cfg),
	}
}
