...
func Get_networks_networkid_snmpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/snmp", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_snmpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_snmp",
		mcp.WithDescription("Return The SNMP Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_snmpHandler(cfg),
	}
}
