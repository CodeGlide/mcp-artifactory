...
func Put_networks_networkid_snmpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_snmpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_snmp",
		mcp.WithDescription("Update The SNMP Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_snmpHandler(cfg),
	}
}
