...
func Get_v1_teams_team_name_users_user_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/users/%s", cfg.BaseURL, team_name, user_name)
...
func CreateGet_v1_teams_team_name_users_user_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_users_user_name",
		mcp.WithDescription("Retrieve a User"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_users_user_nameHandler(cfg),
	}
}
