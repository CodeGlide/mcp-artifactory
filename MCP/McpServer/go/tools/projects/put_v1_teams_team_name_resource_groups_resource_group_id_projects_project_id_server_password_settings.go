...
func Put_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_server_password_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_server_password_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_server_password_settings",
		mcp.WithDescription("Update Project Password Policy for Server Accounts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_server_password_settingsHandler(cfg),
	}
}
