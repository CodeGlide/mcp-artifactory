...
func Post_v1_teams_team_name_resource_groups_resource_group_id_projectsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resource_groups/%s/projects", cfg.BaseURL, team_name, resource_group_id)
...
func CreatePost_v1_teams_team_name_resource_groups_resource_group_id_projectsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_resource_groups_resource_group_id_projects",
		mcp.WithDescription("Create a Project in a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_resource_groups_resource_group_id_projectsHandler(cfg),
	}
}
