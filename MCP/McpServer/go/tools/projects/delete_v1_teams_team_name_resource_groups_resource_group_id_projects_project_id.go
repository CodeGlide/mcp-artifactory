...
func Delete_v1_teams_team_name_resource_groups_resource_group_id_projects_project_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resource_groups/%s/projects/%s", cfg.BaseURL, team_name, resource_group_id, project_id)
...
func CreateDelete_v1_teams_team_name_resource_groups_resource_group_id_projects_project_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id",
		mcp.WithDescription("Delete a Project from a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_v1_teams_team_name_resource_groups_resource_group_id_projects_project_idHandler(cfg),
	}
}
