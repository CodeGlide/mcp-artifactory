...
func Get_v1_teams_team_name_resource_groups_resource_group_id_projectsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_resource_groups_resource_group_id_projectsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_resource_groups_resource_group_id_projects",
		mcp.WithDescription("List all Projects in a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_resource_groups_resource_group_id_projectsHandler(cfg),
	}
}
