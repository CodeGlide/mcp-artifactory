...
func Put_networks_networkid_switch_mtuHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_switch_mtuTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_mtu",
		mcp.WithDescription("Update The MTU Configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_mtuHandler(cfg),
	}
}
