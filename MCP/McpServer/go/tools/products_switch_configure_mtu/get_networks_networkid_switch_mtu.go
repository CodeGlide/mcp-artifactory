...
func Get_networks_networkid_switch_mtuHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/mtu", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_switch_mtuTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_mtu",
		mcp.WithDescription("Return The MTU Configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_mtuHandler(cfg),
	}
}
