...
func Get_networks_networkid_clientsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_clientsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients",
		mcp.WithDescription("List the Clients in a Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clientsHandler(cfg),
	}
}
