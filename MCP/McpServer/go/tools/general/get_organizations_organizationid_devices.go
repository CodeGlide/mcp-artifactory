...
func Get_organizations_organizationid_devicesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/devices", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_devicesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_devices",
		mcp.WithDescription("List the Devices in an Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_devicesHandler(cfg),
	}
}
