...
func Get_organizations_organizationid_networksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/networks", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_networksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_networks",
		mcp.WithDescription("List the Networks in an Organization "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_networksHandler(cfg),
	}
}
