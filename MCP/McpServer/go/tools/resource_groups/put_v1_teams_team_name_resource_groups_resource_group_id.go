...
func Put_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_resource_groups_resource_group_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_resource_groups_resource_group_id",
		mcp.WithDescription("Update a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg),
	}
}
