...
func Post_v1_teams_team_name_resource_groupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resource_groups", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_resource_groupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_resource_groups",
		mcp.WithDescription("Create a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_resource_groupsHandler(cfg),
	}
}
