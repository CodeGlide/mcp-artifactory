...
func Delete_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_v1_teams_team_name_resource_groups_resource_group_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v1_teams_team_name_resource_groups_resource_group_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg),
	}
}
