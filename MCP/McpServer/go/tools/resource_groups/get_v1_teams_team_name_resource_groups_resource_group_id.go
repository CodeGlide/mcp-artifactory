...
func Get_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resource_groups/%s", cfg.BaseURL, team_name, resource_group_id)
...
func CreateGet_v1_teams_team_name_resource_groups_resource_group_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_resource_groups_resource_group_id",
		mcp.WithDescription("Retrieve a Resource Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_resource_groups_resource_group_idHandler(cfg),
	}
}
