...
func Get_networks_networkid_sm_useraccessdevicesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/userAccessDevices", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_sm_useraccessdevicesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_userAccessDevices",
		mcp.WithDescription("List User Access Devices And Its Trusted Access Connections"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_useraccessdevicesHandler(cfg),
	}
}
