...
func Get_networks_networkid_trafficHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/traffic", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_trafficTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_traffic",
		mcp.WithDescription("Return the traffic analysis data for this network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_trafficHandler(cfg),
	}
}
