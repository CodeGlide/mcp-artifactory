...
func Put_devices_serial_wireless_bluetooth_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/wireless/bluetooth/settings", cfg.BaseURL, serial)
...
func CreatePut_devices_serial_wireless_bluetooth_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_wireless_bluetooth_settings",
		mcp.WithDescription("Update The Bluetooth Settings For A Wireless Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_wireless_bluetooth_settingsHandler(cfg),
	}
}
