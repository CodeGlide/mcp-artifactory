...
func Put_networks_networkid_firmwareupgradesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/firmwareUpgrades", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_firmwareupgradesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_firmwareUpgrades",
		mcp.WithDescription("Update Firmware Upgrade Information For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_firmwareupgradesHandler(cfg),
	}
}
