...
func Put_networks_networkid_appliance_vpn_sitetositevpnHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/vpn/siteToSiteVpn", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_vpn_sitetositevpnTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_vpn_siteToSiteVpn",
		mcp.WithDescription("Update The Site To Site VPN Settings Of A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_vpn_sitetositevpnHandler(cfg),
	}
}
