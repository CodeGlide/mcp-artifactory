...
func Get_devices_serial_wireless_statusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/wireless/status", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_wireless_statusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_wireless_status",
		mcp.WithDescription("Return the SSID statuses of an access point"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_wireless_statusHandler(cfg),
	}
}
