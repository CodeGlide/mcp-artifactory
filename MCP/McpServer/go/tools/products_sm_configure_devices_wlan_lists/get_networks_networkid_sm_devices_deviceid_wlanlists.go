...
func Get_networks_networkid_sm_devices_deviceid_wlanlistsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/%s/wlanLists", cfg.BaseURL, networkId, deviceId)
...
func CreateGet_networks_networkid_sm_devices_deviceid_wlanlistsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_devices_deviceId_wlanLists",
		mcp.WithDescription("List the saved SSID names on a device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_devices_deviceid_wlanlistsHandler(cfg),
	}
}
