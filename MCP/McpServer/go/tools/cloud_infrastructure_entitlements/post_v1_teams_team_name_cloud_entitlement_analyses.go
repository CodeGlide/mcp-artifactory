...
func Post_v1_teams_team_name_cloud_entitlement_analysesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/cloud_entitlement_analyses", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_cloud_entitlement_analysesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_cloud_entitlement_analyses",
		mcp.WithDescription("Create a Cloud Entitlement Job"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_cloud_entitlement_analysesHandler(cfg),
	}
}
