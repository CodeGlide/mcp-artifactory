...
func Get_v1_teams_team_name_cloud_connectionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_cloud_connectionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_cloud_connections",
		mcp.WithDescription("List all Cloud Connections"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_cloud_connectionsHandler(cfg),
	}
}
