...
func Delete_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/cloud_entitlement_analyses/%s", cfg.BaseURL, team_name, cloud_entitlement_analysis_id)
...
func CreateDelete_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id",
		mcp.WithDescription("Delete a Cloud Entitlement Job"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idHandler(cfg),
	}
}
