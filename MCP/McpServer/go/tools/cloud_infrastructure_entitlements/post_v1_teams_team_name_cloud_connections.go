...
func Post_v1_teams_team_name_cloud_connectionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/cloud_connections", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_cloud_connectionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_cloud_connections",
		mcp.WithDescription("Create a Cloud Connection"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_cloud_connectionsHandler(cfg),
	}
}
