...
func Put_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id",
		mcp.WithDescription("Update a Cloud Entitlement Job"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_idHandler(cfg),
	}
}
