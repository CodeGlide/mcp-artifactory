...
func Post_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id_summaryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/cloud_entitlement_analyses/%s/summary", cfg.BaseURL, team_name, cloud_entitlement_analysis_id)
...
func CreatePost_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id_summaryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id_summary",
		mcp.WithDescription("Retrieve a Cloud Entitlement Job Summary"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_cloud_entitlement_analyses_cloud_entitlement_analysis_id_summaryHandler(cfg),
	}
}
