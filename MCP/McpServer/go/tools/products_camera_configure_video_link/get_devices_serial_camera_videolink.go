...
func Get_devices_serial_camera_videolinkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/videoLink", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_camera_videolinkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_videoLink",
		mcp.WithDescription("Returns video link to the specified camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_videolinkHandler(cfg),
	}
}
