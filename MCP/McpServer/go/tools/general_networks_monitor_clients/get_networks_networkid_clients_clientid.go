...
func Get_networks_networkid_clients_clientidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/%s", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_clients_clientidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_clientId",
		mcp.WithDescription("Return The Client Associated With The Given Identifier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_clientidHandler(cfg),
	}
}
