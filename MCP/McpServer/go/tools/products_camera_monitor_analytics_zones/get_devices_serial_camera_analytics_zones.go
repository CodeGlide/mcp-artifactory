...
func Get_devices_serial_camera_analytics_zonesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/analytics/zones", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_camera_analytics_zonesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_analytics_zones",
		mcp.WithDescription("Returns All Configured Analytic Zones For This Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_analytics_zonesHandler(cfg),
	}
}
