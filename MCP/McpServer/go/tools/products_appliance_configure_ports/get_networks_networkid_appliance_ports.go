...
func Get_networks_networkid_appliance_portsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/ports", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_appliance_portsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_ports",
		mcp.WithDescription("List Per Port VLAN Settings For All Ports Of A MX"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_portsHandler(cfg),
	}
}
