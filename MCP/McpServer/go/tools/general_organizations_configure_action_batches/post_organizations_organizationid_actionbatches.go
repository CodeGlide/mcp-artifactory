...
func Post_organizations_organizationid_actionbatchesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_organizations_organizationid_actionbatchesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_actionBatches",
		mcp.WithDescription("Create An Action Batch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_actionbatchesHandler(cfg),
	}
}
