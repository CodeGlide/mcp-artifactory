...
func Get_organizations_organizationid_actionbatchesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/actionBatches", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_actionbatchesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_actionBatches",
		mcp.WithDescription("Return The List Of Action Batches In The Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_actionbatchesHandler(cfg),
	}
}
