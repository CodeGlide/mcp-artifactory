...
func Put_networks_networkid_appliance_trafficshaping_uplinkselectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/trafficShaping/uplinkSelection", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_trafficshaping_uplinkselectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_trafficShaping_uplinkSelection",
		mcp.WithDescription("Update Uplink Selection Settings For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_trafficshaping_uplinkselectionHandler(cfg),
	}
}
