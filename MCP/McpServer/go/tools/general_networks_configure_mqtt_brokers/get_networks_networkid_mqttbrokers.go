...
func Get_networks_networkid_mqttbrokersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/mqttBrokers", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_mqttbrokersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_mqttBrokers",
		mcp.WithDescription("List The MQTT Brokers For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_mqttbrokersHandler(cfg),
	}
}
