...
func Post_networks_networkid_mqttbrokersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_mqttbrokersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_mqttBrokers",
		mcp.WithDescription("Add An MQTT Broker"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_mqttbrokersHandler(cfg),
	}
}
