...
func Post_networks_networkid_switch_portschedulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/portSchedules", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_switch_portschedulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_portSchedules",
		mcp.WithDescription("Add A Switch Port Schedule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_portschedulesHandler(cfg),
	}
}
