...
func Delete_organizations_organizationidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_organizations_organizationidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_organizations_organizationId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_organizations_organizationidHandler(cfg),
	}
}
