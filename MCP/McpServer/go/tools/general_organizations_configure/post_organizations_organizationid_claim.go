...
func Post_organizations_organizationid_claimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/claim", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_claimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_claim",
		mcp.WithDescription("Claim A List Of Devices Licenses And Or Orders Into An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_claimHandler(cfg),
	}
}
