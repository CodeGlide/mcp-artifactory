...
func Put_organizations_organizationidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationidHandler(cfg),
	}
}
