...
func Get_organizations_organizationidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId",
		mcp.WithDescription("Return An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationidHandler(cfg),
	}
}
