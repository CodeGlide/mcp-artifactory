...
func Get_networks_networkid_wireless_meshstatusesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/meshStatuses", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_meshstatusesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_meshStatuses",
		mcp.WithDescription("List wireless mesh statuses for repeaters"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_meshstatusesHandler(cfg),
	}
}
