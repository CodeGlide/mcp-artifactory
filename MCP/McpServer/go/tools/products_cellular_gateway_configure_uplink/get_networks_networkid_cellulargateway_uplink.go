...
func Get_networks_networkid_cellulargateway_uplinkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/cellularGateway/uplink", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_cellulargateway_uplinkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_cellularGateway_uplink",
		mcp.WithDescription("Returns The Uplink Settings For Your MG Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_cellulargateway_uplinkHandler(cfg),
	}
}
