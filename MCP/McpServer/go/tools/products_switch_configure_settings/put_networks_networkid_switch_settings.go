...
func Put_networks_networkid_switch_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_switch_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_settings",
		mcp.WithDescription("Update Switch Network Settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_settingsHandler(cfg),
	}
}
