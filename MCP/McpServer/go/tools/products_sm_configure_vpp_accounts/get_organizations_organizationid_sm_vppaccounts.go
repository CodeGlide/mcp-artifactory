...
func Get_organizations_organizationid_sm_vppaccountsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/sm/vppAccounts", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_sm_vppaccountsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_sm_vppAccounts",
		mcp.WithDescription("List The VPP Accounts In The Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_sm_vppaccountsHandler(cfg),
	}
}
