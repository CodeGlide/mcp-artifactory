...
func Put_networks_networkid_appliance_firewall_portforwardingrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/firewall/portForwardingRules", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_firewall_portforwardingrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_firewall_portForwardingRules",
		mcp.WithDescription("Update The Port Forwarding Rules For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_firewall_portforwardingrulesHandler(cfg),
	}
}
