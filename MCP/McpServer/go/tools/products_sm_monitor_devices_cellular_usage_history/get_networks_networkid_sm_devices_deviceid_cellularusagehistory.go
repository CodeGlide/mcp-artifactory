...
func Get_networks_networkid_sm_devices_deviceid_cellularusagehistoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/%s/cellularUsageHistory", cfg.BaseURL, networkId, deviceId)
...
func CreateGet_networks_networkid_sm_devices_deviceid_cellularusagehistoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_devices_deviceId_cellularUsageHistory",
		mcp.WithDescription("Return the client's daily cellular data usage history"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_devices_deviceid_cellularusagehistoryHandler(cfg),
	}
}
