...
func Put_networks_networkid_wireless_ssids_number_trafficshaping_rulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/ssids/%s/trafficShaping/rules", cfg.BaseURL, networkId, number)
...
func CreatePut_networks_networkid_wireless_ssids_number_trafficshaping_rulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_ssids_number_trafficShaping_rules",
		mcp.WithDescription("Update The Traffic Shaping Settings For An SSID On An MR Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_ssids_number_trafficshaping_rulesHandler(cfg),
	}
}
