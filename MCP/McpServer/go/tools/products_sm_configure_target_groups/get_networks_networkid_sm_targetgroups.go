...
func Get_networks_networkid_sm_targetgroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/targetGroups", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_sm_targetgroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_targetGroups",
		mcp.WithDescription("List The Target Groups In This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_targetgroupsHandler(cfg),
	}
}
