...
func Post_networks_networkid_sm_targetgroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_sm_targetgroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_targetGroups",
		mcp.WithDescription("Add A Target Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_targetgroupsHandler(cfg),
	}
}
