...
func Get_networks_networkid_clients_clientid_policyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/%s/policy", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_clients_clientid_policyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_clientId_policy",
		mcp.WithDescription("Return The Policy Assigned To A Client On The Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_clientid_policyHandler(cfg),
	}
}
