...
func Put_networks_networkid_clients_clientid_policyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_clients_clientid_policyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_clients_clientId_policy",
		mcp.WithDescription("Update The Policy Assigned To A Client On The Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_clients_clientid_policyHandler(cfg),
	}
}
