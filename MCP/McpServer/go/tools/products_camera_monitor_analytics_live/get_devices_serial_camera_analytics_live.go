...
func Get_devices_serial_camera_analytics_liveHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/analytics/live", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_camera_analytics_liveTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_analytics_live",
		mcp.WithDescription("Returns live state from camera of analytics zones"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_analytics_liveHandler(cfg),
	}
}
