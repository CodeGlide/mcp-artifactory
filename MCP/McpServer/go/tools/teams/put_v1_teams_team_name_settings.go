...
func Put_v1_teams_team_name_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_settings",
		mcp.WithDescription("Update settings for a Team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_settingsHandler(cfg),
	}
}
