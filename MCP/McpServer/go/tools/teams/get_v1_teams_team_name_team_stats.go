...
func Get_v1_teams_team_name_team_statsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/team_stats", cfg.BaseURL, team_name)
...
func CreateGet_v1_teams_team_name_team_statsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_team_stats",
		mcp.WithDescription("Retrieve statistics for a Team"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_team_statsHandler(cfg),
	}
}
