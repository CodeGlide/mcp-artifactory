...
func Get_organizations_organizationid_licenses_overviewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/licenses/overview", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_licenses_overviewTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_licenses_overview",
		mcp.WithDescription("Return an overview of the license state for an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_licenses_overviewHandler(cfg),
	}
}
