...
func Post_networks_networkid_switch_stacksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_switch_stacksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_stacks",
		mcp.WithDescription("Create A Stack"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_stacksHandler(cfg),
	}
}
