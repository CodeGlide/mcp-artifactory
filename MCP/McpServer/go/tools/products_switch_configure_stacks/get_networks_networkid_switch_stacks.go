...
func Get_networks_networkid_switch_stacksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stacks", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_switch_stacksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_stacks",
		mcp.WithDescription("List The Switch Stacks In A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_stacksHandler(cfg),
	}
}
