...
func Post_networks_networkid_switch_stacks_switchstackid_addHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stacks/%s/add", cfg.BaseURL, networkId, switchStackId)
...
func CreatePost_networks_networkid_switch_stacks_switchstackid_addTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_stacks_switchStackId_add",
		mcp.WithDescription("Add A Switch To A Stack"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_stacks_switchstackid_addHandler(cfg),
	}
}
