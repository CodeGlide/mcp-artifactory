...
func Post_networks_networkid_switch_stacks_switchstackid_removeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stacks/%s/remove", cfg.BaseURL, networkId, switchStackId)
...
func CreatePost_networks_networkid_switch_stacks_switchstackid_removeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_stacks_switchStackId_remove",
		mcp.WithDescription("Remove A Switch From A Stack"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_stacks_switchstackid_removeHandler(cfg),
	}
}
