...
func Get_organizations_organizationid_brandingpoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_organizations_organizationid_brandingpoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_brandingPolicies",
		mcp.WithDescription("List The Branding Policies Of An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_brandingpoliciesHandler(cfg),
	}
}
