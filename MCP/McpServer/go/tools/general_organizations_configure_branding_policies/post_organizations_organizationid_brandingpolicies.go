...
func Post_organizations_organizationid_brandingpoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/brandingPolicies", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_brandingpoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_brandingPolicies",
		mcp.WithDescription("Add A New Branding Policy To An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_brandingpoliciesHandler(cfg),
	}
}
