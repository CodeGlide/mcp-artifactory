...
func Get_devices_serial_camera_analytics_recentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/analytics/recent", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_camera_analytics_recentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_analytics_recent",
		mcp.WithDescription("Returns most recent record for analytics zones"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_analytics_recentHandler(cfg),
	}
}
