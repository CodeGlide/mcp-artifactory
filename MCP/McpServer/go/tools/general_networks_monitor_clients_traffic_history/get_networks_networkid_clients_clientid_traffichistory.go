...
func Get_networks_networkid_clients_clientid_traffichistoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/%s/trafficHistory", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_clients_clientid_traffichistoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_clientId_trafficHistory",
		mcp.WithDescription("Return the client's network traffic data over time"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_clientid_traffichistoryHandler(cfg),
	}
}
