...
func Get_networks_networkid_clients_applicationusageHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/applicationUsage", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_clients_applicationusageTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_applicationUsage",
		mcp.WithDescription("Return the application usage data for clients"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_applicationusageHandler(cfg),
	}
}
