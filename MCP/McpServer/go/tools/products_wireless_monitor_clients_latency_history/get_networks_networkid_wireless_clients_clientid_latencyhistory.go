...
func Get_networks_networkid_wireless_clients_clientid_latencyhistoryHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/clients/%s/latencyHistory", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_wireless_clients_clientid_latencyhistoryTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_clients_clientId_latencyHistory",
		mcp.WithDescription("Return the latency history for a client"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_clients_clientid_latencyhistoryHandler(cfg),
	}
}
