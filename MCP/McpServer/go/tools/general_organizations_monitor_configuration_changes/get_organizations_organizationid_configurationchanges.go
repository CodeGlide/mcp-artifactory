...
func Get_organizations_organizationid_configurationchangesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/configurationChanges", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_configurationchangesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_configurationChanges",
		mcp.WithDescription("View the Change Log for your organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_configurationchangesHandler(cfg),
	}
}
