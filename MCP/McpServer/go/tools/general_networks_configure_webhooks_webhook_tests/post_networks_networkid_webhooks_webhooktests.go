...
func Post_networks_networkid_webhooks_webhooktestsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/webhooks/webhookTests", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_webhooks_webhooktestsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_webhooks_webhookTests",
		mcp.WithDescription("Send A Test Webhook For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_webhooks_webhooktestsHandler(cfg),
	}
}
