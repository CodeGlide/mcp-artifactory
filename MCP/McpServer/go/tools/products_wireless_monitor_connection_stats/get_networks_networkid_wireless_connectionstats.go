...
func Get_networks_networkid_wireless_connectionstatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/connectionStats", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_connectionstatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_connectionStats",
		mcp.WithDescription("Aggregated Connectivity Info For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_connectionstatsHandler(cfg),
	}
}
