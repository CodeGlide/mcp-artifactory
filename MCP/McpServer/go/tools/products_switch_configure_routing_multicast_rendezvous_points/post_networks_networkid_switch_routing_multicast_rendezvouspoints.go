...
func Post_networks_networkid_switch_routing_multicast_rendezvouspointsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/routing/multicast/rendezvousPoints", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_switch_routing_multicast_rendezvouspointsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_routing_multicast_rendezvousPoints",
		mcp.WithDescription("Create A Multicast Rendezvous Point"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_routing_multicast_rendezvouspointsHandler(cfg),
	}
}
