...
func Put_networks_networkid_appliance_trafficshapingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_appliance_trafficshapingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_trafficShaping",
		mcp.WithDescription("Update The Traffic Shaping Settings For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_trafficshapingHandler(cfg),
	}
}
