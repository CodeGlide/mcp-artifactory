...
func Put_organizations_organizationid_appliance_vpn_thirdpartyvpnpeersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/appliance/vpn/thirdPartyVPNPeers", cfg.BaseURL, organizationId)
...
func CreatePut_organizations_organizationid_appliance_vpn_thirdpartyvpnpeersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_appliance_vpn_thirdPartyVPNPeers",
		mcp.WithDescription("Update The Third Party VPN Peers For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_appliance_vpn_thirdpartyvpnpeersHandler(cfg),
	}
}
