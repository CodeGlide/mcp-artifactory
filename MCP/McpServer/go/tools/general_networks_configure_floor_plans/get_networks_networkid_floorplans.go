...
func Get_networks_networkid_floorplansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/floorPlans", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_floorplansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_floorPlans",
		mcp.WithDescription("List The Floor Plans That Belong To Your Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_floorplansHandler(cfg),
	}
}
