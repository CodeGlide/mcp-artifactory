...
func Post_networks_networkid_floorplansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_floorplansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_floorPlans",
		mcp.WithDescription("Upload A Floor Plan"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_floorplansHandler(cfg),
	}
}
