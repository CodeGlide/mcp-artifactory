...
func Get_networks_networkid_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/settings", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_settings",
		mcp.WithDescription("Return The Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_settingsHandler(cfg),
	}
}
