...
func Put_networks_networkid_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_settings",
		mcp.WithDescription("Update The Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_settingsHandler(cfg),
	}
}
