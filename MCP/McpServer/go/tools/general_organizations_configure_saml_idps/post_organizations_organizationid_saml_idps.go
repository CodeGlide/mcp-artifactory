...
func Post_organizations_organizationid_saml_idpsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/saml/idps", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_saml_idpsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_saml_idps",
		mcp.WithDescription("Create A SAML Id P For Your Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_saml_idpsHandler(cfg),
	}
}
