...
func Get_organizations_organizationid_sm_apnscertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/sm/apnsCert", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_sm_apnscertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_sm_apnsCert",
		mcp.WithDescription("Get the organization's APNS certificate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_sm_apnscertHandler(cfg),
	}
}
