...
func Put_organizations_organizationid_brandingpolicies_prioritiesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationid_brandingpolicies_prioritiesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_brandingPolicies_priorities",
		mcp.WithDescription("Update The Priority Ordering Of An Organizations Branding Policies"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_brandingpolicies_prioritiesHandler(cfg),
	}
}
