...
func Get_networks_networkid_merakiauthusers_merakiauthuseridHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkid_merakiauthusers_merakiauthuseridTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_merakiAuthUsers_merakiAuthUserId",
		mcp.WithDescription("Return The Meraki Auth Splash Guest RADIUS Or Client VPN User"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_merakiauthusers_merakiauthuseridHandler(cfg),
	}
}
