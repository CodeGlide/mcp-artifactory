...
func Put_networks_networkid_merakiauthusers_merakiauthuseridHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_merakiauthusers_merakiauthuseridTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_merakiAuthUsers_merakiAuthUserId",
		mcp.WithDescription("Update A User Configured With Meraki Authentication Currently 802 1 X RADIUS Splash Guest And Client VPN Users Can Be Updated"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_merakiauthusers_merakiauthuseridHandler(cfg),
	}
}
