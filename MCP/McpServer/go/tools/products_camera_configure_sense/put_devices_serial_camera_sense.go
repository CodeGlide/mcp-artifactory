...
func Put_devices_serial_camera_senseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/sense", cfg.BaseURL, serial)
...
func CreatePut_devices_serial_camera_senseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_camera_sense",
		mcp.WithDescription("Update Sense Settings For The Given Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_camera_senseHandler(cfg),
	}
}
