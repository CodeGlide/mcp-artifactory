...
func Get_devices_serial_camera_senseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_devices_serial_camera_senseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_sense",
		mcp.WithDescription("Returns Sense Settings For A Given Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_senseHandler(cfg),
	}
}
