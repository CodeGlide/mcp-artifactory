...
func Get_organizations_organizationid_webhooks_logsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/webhooks/logs", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_webhooks_logsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_webhooks_logs",
		mcp.WithDescription("Return the log of webhook POSTs sent"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_webhooks_logsHandler(cfg),
	}
}
