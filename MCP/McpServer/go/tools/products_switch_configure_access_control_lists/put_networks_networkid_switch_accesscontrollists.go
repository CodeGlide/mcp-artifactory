...
func Put_networks_networkid_switch_accesscontrollistsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/accessControlLists", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_switch_accesscontrollistsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_accessControlLists",
		mcp.WithDescription("Update The Access Control Lists For A MS Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_accesscontrollistsHandler(cfg),
	}
}
