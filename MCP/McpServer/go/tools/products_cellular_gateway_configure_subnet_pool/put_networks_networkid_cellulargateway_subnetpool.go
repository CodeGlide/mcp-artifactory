...
func Put_networks_networkid_cellulargateway_subnetpoolHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/cellularGateway/subnetPool", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_cellulargateway_subnetpoolTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_cellularGateway_subnetPool",
		mcp.WithDescription("Update The Subnet Pool And Mask Configuration For M Gs In The Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_cellulargateway_subnetpoolHandler(cfg),
	}
}
