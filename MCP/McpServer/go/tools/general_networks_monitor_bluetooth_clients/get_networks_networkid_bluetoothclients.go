...
func Get_networks_networkid_bluetoothclientsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/bluetoothClients", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_bluetoothclientsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_bluetoothClients",
		mcp.WithDescription("List The Bluetooth Clients Seen By A Ps In This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_bluetoothclientsHandler(cfg),
	}
}
