...
func Get_organizations_organizationid_appliance_vpn_statsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/appliance/vpn/stats", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_appliance_vpn_statsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_appliance_vpn_stats",
		mcp.WithDescription("Show VPN history stat for networks in an organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_appliance_vpn_statsHandler(cfg),
	}
}
