...
func Delete_v1_teams_team_name_gateways_gateway_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_v1_teams_team_name_gateways_gateway_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_v1_teams_team_name_gateways_gateway_id",
		mcp.WithDescription("Delete a Gateway"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_v1_teams_team_name_gateways_gateway_idHandler(cfg),
	}
}
