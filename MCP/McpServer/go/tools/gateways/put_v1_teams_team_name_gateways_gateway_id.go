...
func Put_v1_teams_team_name_gateways_gateway_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_gateways_gateway_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_gateways_gateway_id",
		mcp.WithDescription("Update a Gateway"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_gateways_gateway_idHandler(cfg),
	}
}
