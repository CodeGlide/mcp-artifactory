...
func Post_networks_networkid_appliance_vlansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_appliance_vlansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_appliance_vlans",
		mcp.WithDescription("Add A VLAN"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_appliance_vlansHandler(cfg),
	}
}
