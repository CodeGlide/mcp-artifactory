...
func Get_networks_networkid_appliance_vlansHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/vlans", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_appliance_vlansTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_vlans",
		mcp.WithDescription("List The VLA Ns For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_vlansHandler(cfg),
	}
}
