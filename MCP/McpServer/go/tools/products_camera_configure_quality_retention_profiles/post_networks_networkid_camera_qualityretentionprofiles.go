...
func Post_networks_networkid_camera_qualityretentionprofilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/camera/qualityRetentionProfiles", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_camera_qualityretentionprofilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_camera_qualityRetentionProfiles",
		mcp.WithDescription("Creates New Quality Retention Profile For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_camera_qualityretentionprofilesHandler(cfg),
	}
}
