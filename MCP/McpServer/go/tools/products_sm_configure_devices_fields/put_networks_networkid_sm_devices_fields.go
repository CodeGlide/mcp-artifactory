...
func Put_networks_networkid_sm_devices_fieldsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/fields", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_sm_devices_fieldsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_sm_devices_fields",
		mcp.WithDescription("Modify the fields of a device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_sm_devices_fieldsHandler(cfg),
	}
}
