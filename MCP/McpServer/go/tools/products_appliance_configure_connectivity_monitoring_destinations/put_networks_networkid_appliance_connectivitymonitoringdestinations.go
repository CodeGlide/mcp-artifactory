...
func Put_networks_networkid_appliance_connectivitymonitoringdestinationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/connectivityMonitoringDestinations", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_connectivitymonitoringdestinationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_connectivityMonitoringDestinations",
		mcp.WithDescription("Update The Connectivity Testing Destinations For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_connectivitymonitoringdestinationsHandler(cfg),
	}
}
