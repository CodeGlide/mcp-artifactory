...
func Get_networks_networkid_appliance_security_eventsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/security/events", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_appliance_security_eventsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_security_events",
		mcp.WithDescription("List The Security Events For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_security_eventsHandler(cfg),
	}
}
