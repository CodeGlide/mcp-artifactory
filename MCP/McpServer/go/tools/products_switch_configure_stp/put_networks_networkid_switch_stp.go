...
func Put_networks_networkid_switch_stpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_switch_stpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_stp",
		mcp.WithDescription("Updates STP Settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_stpHandler(cfg),
	}
}
