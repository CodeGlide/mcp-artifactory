...
func Get_networks_networkid_switch_stpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stp", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_switch_stpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_stp",
		mcp.WithDescription("Returns STP Settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_stpHandler(cfg),
	}
}
