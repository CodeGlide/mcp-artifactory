...
func Post_networks_networkid_firmwareupgrades_rollbacksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/firmwareUpgrades/rollbacks", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_firmwareupgrades_rollbacksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_firmwareUpgrades_rollbacks",
		mcp.WithDescription("Rollback a Firmware Upgrade For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_firmwareupgrades_rollbacksHandler(cfg),
	}
}
