...
func Get_devices_serial_switch_ports_statusesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/switch/ports/statuses", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_switch_ports_statusesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_switch_ports_statuses",
		mcp.WithDescription("Return The Status For All The Ports Of A Switch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_switch_ports_statusesHandler(cfg),
	}
}
