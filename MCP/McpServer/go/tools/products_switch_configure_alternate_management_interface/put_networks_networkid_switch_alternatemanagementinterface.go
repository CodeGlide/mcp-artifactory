...
func Put_networks_networkid_switch_alternatemanagementinterfaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/alternateManagementInterface", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_switch_alternatemanagementinterfaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_alternateManagementInterface",
		mcp.WithDescription("Update The Switch Alternate Management Interface For The Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_alternatemanagementinterfaceHandler(cfg),
	}
}
