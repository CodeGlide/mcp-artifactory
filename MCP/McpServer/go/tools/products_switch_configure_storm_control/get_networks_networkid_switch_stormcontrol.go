...
func Get_networks_networkid_switch_stormcontrolHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stormControl", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_switch_stormcontrolTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_stormControl",
		mcp.WithDescription("Return The Storm Control Configuration For A Switch Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_stormcontrolHandler(cfg),
	}
}
