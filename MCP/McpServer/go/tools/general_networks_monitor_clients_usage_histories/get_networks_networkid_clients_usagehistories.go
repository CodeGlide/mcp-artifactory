...
func Get_networks_networkid_clients_usagehistoriesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/usageHistories", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_clients_usagehistoriesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_usageHistories",
		mcp.WithDescription("Return the usage histories for clients"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_usagehistoriesHandler(cfg),
	}
}
