...
func Get_devices_serial_switch_warmspareHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/switch/warmSpare", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_switch_warmspareTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_switch_warmSpare",
		mcp.WithDescription("Return Warm Spare Configuration For A Switch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_switch_warmspareHandler(cfg),
	}
}
