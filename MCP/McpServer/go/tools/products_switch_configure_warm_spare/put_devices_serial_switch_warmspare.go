...
func Put_devices_serial_switch_warmspareHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_devices_serial_switch_warmspareTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_switch_warmSpare",
		mcp.WithDescription("Update Warm Spare Configuration For A Switch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_switch_warmspareHandler(cfg),
	}
}
