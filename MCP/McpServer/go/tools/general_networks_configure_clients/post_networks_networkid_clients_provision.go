...
func Post_networks_networkid_clients_provisionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/provision", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_clients_provisionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_clients_provision",
		mcp.WithDescription("Provisions A Client With A Name And Policy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_clients_provisionHandler(cfg),
	}
}
