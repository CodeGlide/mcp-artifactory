...
func Get_networks_networkid_sm_profilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/profiles", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_sm_profilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_sm_profiles",
		mcp.WithDescription("List all profiles in a network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_sm_profilesHandler(cfg),
	}
}
