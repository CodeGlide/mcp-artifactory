...
func Post_networks_networkid_sm_devices_deviceid_refreshdetailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/%s/refreshDetails", cfg.BaseURL, networkId, deviceId)
...
func CreatePost_networks_networkid_sm_devices_deviceid_refreshdetailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_devices_deviceId_refreshDetails",
		mcp.WithDescription("Refresh The Details Of A Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_devices_deviceid_refreshdetailsHandler(cfg),
	}
}
