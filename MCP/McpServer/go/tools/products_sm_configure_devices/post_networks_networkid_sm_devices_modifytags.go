...
func Post_networks_networkid_sm_devices_modifytagsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/modifyTags", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_sm_devices_modifytagsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_devices_modifyTags",
		mcp.WithDescription("Add Delete Or Update The Tags Of A Set Of Devices"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_devices_modifytagsHandler(cfg),
	}
}
