...
func Post_networks_networkid_sm_devices_wipeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/wipe", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_sm_devices_wipeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_devices_wipe",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_devices_wipeHandler(cfg),
	}
}
