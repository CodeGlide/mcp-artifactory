...
func Post_networks_networkid_sm_devices_checkinHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/devices/checkin", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_sm_devices_checkinTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_devices_checkin",
		mcp.WithDescription("Force Check In A Set Of Devices"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_devices_checkinHandler(cfg),
	}
}
