...
func Post_v1_teams_team_name_security_policyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/security_policy", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_security_policyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_security_policy",
		mcp.WithDescription("Create a Security Policy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_security_policyHandler(cfg),
	}
}
