...
func Get_v1_teams_team_name_security_policyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_security_policyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_security_policy",
		mcp.WithDescription("List all Security Policies"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_security_policyHandler(cfg),
	}
}
