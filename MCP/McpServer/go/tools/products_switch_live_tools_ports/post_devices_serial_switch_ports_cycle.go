...
func Post_devices_serial_switch_ports_cycleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/switch/ports/cycle", cfg.BaseURL, serial)
...
func CreatePost_devices_serial_switch_ports_cycleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_devices_serial_switch_ports_cycle",
		mcp.WithDescription("Cycle a set of switch ports"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_devices_serial_switch_ports_cycleHandler(cfg),
	}
}
