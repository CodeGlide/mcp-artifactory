...
func Get_organizations_organizationid_loginsecurityHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/loginSecurity", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_loginsecurityTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_loginSecurity",
		mcp.WithDescription("Returns The Login Security Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_loginsecurityHandler(cfg),
	}
}
