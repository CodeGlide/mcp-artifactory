...
func Put_organizations_organizationid_loginsecurityHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationid_loginsecurityTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_loginSecurity",
		mcp.WithDescription("Update The Login Security Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_loginsecurityHandler(cfg),
	}
}
