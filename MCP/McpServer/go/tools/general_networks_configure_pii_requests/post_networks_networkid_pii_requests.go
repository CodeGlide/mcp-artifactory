...
func Post_networks_networkid_pii_requestsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/pii/requests", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_pii_requestsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_pii_requests",
		mcp.WithDescription("Submit A New Delete Or Restrict Processing PII Request"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_pii_requestsHandler(cfg),
	}
}
