...
func Get_networks_networkid_pii_requestsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkid_pii_requestsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_pii_requests",
		mcp.WithDescription("List The PII Requests For This Network Or Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_pii_requestsHandler(cfg),
	}
}
