...
func Put_networks_networkid_clients_clientid_splashauthorizationstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_clients_clientid_splashauthorizationstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_clients_clientId_splashAuthorizationStatus",
		mcp.WithDescription("Update A Clients Splash Authorization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_clients_clientid_splashauthorizationstatusHandler(cfg),
	}
}
