...
func Get_organizations_organizationid_apirequestsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/apiRequests", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_apirequestsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_apiRequests",
		mcp.WithDescription("List The API Requests Made By An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_apirequestsHandler(cfg),
	}
}
