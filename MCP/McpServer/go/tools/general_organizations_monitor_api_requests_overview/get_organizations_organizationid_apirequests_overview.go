...
func Get_organizations_organizationid_apirequests_overviewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/apiRequests/overview", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_apirequests_overviewTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_apiRequests_overview",
		mcp.WithDescription("Return an aggregated overview of API requests data"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_apirequests_overviewHandler(cfg),
	}
}
