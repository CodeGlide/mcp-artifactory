...
func Get_networks_networkid_wireless_ssids_number_identitypsksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/ssids/%s/identityPsks", cfg.BaseURL, networkId, number)
...
func CreateGet_networks_networkid_wireless_ssids_number_identitypsksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_ssids_number_identityPsks",
		mcp.WithDescription("List All Identity PS Ks In A Wireless Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_ssids_number_identitypsksHandler(cfg),
	}
}
