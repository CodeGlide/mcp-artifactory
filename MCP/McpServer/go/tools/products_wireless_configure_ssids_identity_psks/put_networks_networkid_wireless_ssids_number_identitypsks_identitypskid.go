...
func Put_networks_networkid_wireless_ssids_number_identitypsks_identitypskidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_wireless_ssids_number_identitypsks_identitypskidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_ssids_number_identityPsks_identityPskId",
		mcp.WithDescription("Update An Identity PSK"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_ssids_number_identitypsks_identitypskidHandler(cfg),
	}
}
