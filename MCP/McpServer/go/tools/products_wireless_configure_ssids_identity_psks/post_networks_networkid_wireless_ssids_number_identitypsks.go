...
func Post_networks_networkid_wireless_ssids_number_identitypsksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_wireless_ssids_number_identitypsksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_wireless_ssids_number_identityPsks",
		mcp.WithDescription("Create An Identity PSK"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_wireless_ssids_number_identitypsksHandler(cfg),
	}
}
