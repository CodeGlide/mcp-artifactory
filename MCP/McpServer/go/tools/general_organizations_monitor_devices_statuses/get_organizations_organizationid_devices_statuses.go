...
func Get_organizations_organizationid_devices_statusesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/devices/statuses", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_devices_statusesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_devices_statuses",
		mcp.WithDescription("List the status of every Meraki device in the organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_devices_statusesHandler(cfg),
	}
}
