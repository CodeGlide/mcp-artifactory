...
func Post_devices_serial_camera_generatesnapshotHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/generateSnapshot", cfg.BaseURL, serial)
...
func CreatePost_devices_serial_camera_generatesnapshotTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_devices_serial_camera_generateSnapshot",
		mcp.WithDescription("Generate A Snapshot Of What The Camera Sees At The Specified Time And Return A Link To That Image"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_devices_serial_camera_generatesnapshotHandler(cfg),
	}
}
