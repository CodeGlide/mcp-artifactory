...
func Put_networks_networkid_wireless_ssids_number_splash_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_wireless_ssids_number_splash_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_ssids_number_splash_settings",
		mcp.WithDescription("Modify The Splash Page Settings For The Given SSID"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_ssids_number_splash_settingsHandler(cfg),
	}
}
