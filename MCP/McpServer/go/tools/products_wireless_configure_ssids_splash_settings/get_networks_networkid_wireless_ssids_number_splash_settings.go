...
func Get_networks_networkid_wireless_ssids_number_splash_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/ssids/%s/splash/settings", cfg.BaseURL, networkId, number)
...
func CreateGet_networks_networkid_wireless_ssids_number_splash_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_ssids_number_splash_settings",
		mcp.WithDescription("Display The Splash Page Settings For The Given SSID"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_ssids_number_splash_settingsHandler(cfg),
	}
}
