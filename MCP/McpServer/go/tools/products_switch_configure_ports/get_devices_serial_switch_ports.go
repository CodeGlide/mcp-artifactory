...
func Get_devices_serial_switch_portsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/switch/ports", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_switch_portsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_switch_ports",
		mcp.WithDescription("List The Switch Ports For A Switch"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_switch_portsHandler(cfg),
	}
}
