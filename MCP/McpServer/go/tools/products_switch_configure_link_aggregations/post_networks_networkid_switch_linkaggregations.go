...
func Post_networks_networkid_switch_linkaggregationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/linkAggregations", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_switch_linkaggregationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_linkAggregations",
		mcp.WithDescription("Create A Link Aggregation Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_linkaggregationsHandler(cfg),
	}
}
