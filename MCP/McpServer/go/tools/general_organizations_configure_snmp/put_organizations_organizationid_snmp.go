...
func Put_organizations_organizationid_snmpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/snmp", cfg.BaseURL, organizationId)
...
func CreatePut_organizations_organizationid_snmpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_snmp",
		mcp.WithDescription("Update The SNMP Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_snmpHandler(cfg),
	}
}
