...
func Get_organizations_organizationid_snmpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_organizations_organizationid_snmpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_snmp",
		mcp.WithDescription("Return The SNMP Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_snmpHandler(cfg),
	}
}
