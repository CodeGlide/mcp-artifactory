...
func Put_devices_serialHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s", cfg.BaseURL, serial)
...
func CreatePut_devices_serialTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial",
		mcp.WithDescription("Update The Attributes Of A Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serialHandler(cfg),
	}
}
