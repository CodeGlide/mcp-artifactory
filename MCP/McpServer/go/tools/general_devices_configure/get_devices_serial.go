...
func Get_devices_serialHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_devices_serialTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial",
		mcp.WithDescription("Return A Single Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serialHandler(cfg),
	}
}
