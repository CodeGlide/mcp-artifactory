...
func Put_networks_networkid_cellulargateway_connectivitymonitoringdestinationsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/cellularGateway/connectivityMonitoringDestinations", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_cellulargateway_connectivitymonitoringdestinationsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_cellularGateway_connectivityMonitoringDestinations",
		mcp.WithDescription("Update The Connectivity Testing Destinations For An MG Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_cellulargateway_connectivitymonitoringdestinationsHandler(cfg),
	}
}
