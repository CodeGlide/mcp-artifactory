...
func Put_devices_serial_camera_qualityandretentionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_devices_serial_camera_qualityandretentionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_camera_qualityAndRetention",
		mcp.WithDescription("Update Quality And Retention Settings For The Given Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_camera_qualityandretentionHandler(cfg),
	}
}
