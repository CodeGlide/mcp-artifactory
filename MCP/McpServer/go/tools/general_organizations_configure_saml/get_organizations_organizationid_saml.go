...
func Get_organizations_organizationid_samlHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/saml", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_samlTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_saml",
		mcp.WithDescription("Returns The SAML SSO Enabled Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_samlHandler(cfg),
	}
}
