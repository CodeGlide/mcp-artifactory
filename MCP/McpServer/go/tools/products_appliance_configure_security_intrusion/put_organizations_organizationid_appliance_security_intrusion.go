...
func Put_organizations_organizationid_appliance_security_intrusionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationid_appliance_security_intrusionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_appliance_security_intrusion",
		mcp.WithDescription("Sets Supported Intrusion Settings For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_appliance_security_intrusionHandler(cfg),
	}
}
