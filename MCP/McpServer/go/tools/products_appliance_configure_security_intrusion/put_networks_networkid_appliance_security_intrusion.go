...
func Put_networks_networkid_appliance_security_intrusionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_appliance_security_intrusionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_security_intrusion",
		mcp.WithDescription("Set The Supported Intrusion Settings For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_security_intrusionHandler(cfg),
	}
}
