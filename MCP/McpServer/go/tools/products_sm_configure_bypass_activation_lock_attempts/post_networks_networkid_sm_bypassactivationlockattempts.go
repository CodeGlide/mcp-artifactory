...
func Post_networks_networkid_sm_bypassactivationlockattemptsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/sm/bypassActivationLockAttempts", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_sm_bypassactivationlockattemptsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_sm_bypassActivationLockAttempts",
		mcp.WithDescription("Bypass Activation Lock Attempt"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_sm_bypassactivationlockattemptsHandler(cfg),
	}
}
