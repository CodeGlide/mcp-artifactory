...
func Get_networks_networkid_appliance_clients_clientid_security_eventsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/clients/%s/security/events", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_appliance_clients_clientid_security_eventsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_clients_clientId_security_events",
		mcp.WithDescription("List the security events for a client"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_clients_clientid_security_eventsHandler(cfg),
	}
}
