...
func Post_organizations_organizationid_networksHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_organizations_organizationid_networksTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_networks",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_networksHandler(cfg),
	}
}
