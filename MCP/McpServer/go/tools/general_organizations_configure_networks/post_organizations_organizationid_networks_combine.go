...
func Post_organizations_organizationid_networks_combineHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/networks/combine", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_networks_combineTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_networks_combine",
		mcp.WithDescription("Combine Multiple Networks Into A Single Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_networks_combineHandler(cfg),
	}
}
