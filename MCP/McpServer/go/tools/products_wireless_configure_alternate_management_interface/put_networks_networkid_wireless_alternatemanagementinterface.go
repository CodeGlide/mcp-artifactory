...
func Put_networks_networkid_wireless_alternatemanagementinterfaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_wireless_alternatemanagementinterfaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_alternateManagementInterface",
		mcp.WithDescription("Update Alternate Management Interface And Device Static IP"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_alternatemanagementinterfaceHandler(cfg),
	}
}
