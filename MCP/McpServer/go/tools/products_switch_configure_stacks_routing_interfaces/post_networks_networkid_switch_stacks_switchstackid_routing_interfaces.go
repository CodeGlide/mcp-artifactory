...
func Post_networks_networkid_switch_stacks_switchstackid_routing_interfacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/stacks/%s/routing/interfaces", cfg.BaseURL, networkId, switchStackId)
...
func CreatePost_networks_networkid_switch_stacks_switchstackid_routing_interfacesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_stacks_switchStackId_routing_interfaces",
		mcp.WithDescription("Create A Layer 3 Interface For A Switch Stack"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_stacks_switchstackid_routing_interfacesHandler(cfg),
	}
}
