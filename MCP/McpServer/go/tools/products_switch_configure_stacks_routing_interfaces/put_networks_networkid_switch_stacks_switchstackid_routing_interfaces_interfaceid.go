...
func Put_networks_networkid_switch_stacks_switchstackid_routing_interfaces_interfaceidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_switch_stacks_switchstackid_routing_interfaces_interfaceidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_stacks_switchStackId_routing_interfaces_interfaceId",
		mcp.WithDescription("Update A Layer 3 Interface For A Switch Stack"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_stacks_switchstackid_routing_interfaces_interfaceidHandler(cfg),
	}
}
