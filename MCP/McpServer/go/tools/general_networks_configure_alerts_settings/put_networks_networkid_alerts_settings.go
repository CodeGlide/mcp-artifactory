...
func Put_networks_networkid_alerts_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_alerts_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_alerts_settings",
		mcp.WithDescription("Update The Alert Configuration For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_alerts_settingsHandler(cfg),
	}
}
