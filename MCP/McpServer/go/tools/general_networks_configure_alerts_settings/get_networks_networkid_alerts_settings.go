...
func Get_networks_networkid_alerts_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/alerts/settings", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_alerts_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_alerts_settings",
		mcp.WithDescription("Return The Alert Configuration For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_alerts_settingsHandler(cfg),
	}
}
