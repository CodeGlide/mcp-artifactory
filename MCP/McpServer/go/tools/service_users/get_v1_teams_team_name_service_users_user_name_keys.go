...
func Get_v1_teams_team_name_service_users_user_name_keysHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_service_users_user_name_keysTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_service_users_user_name_keys",
		mcp.WithDescription("List all API keys"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_service_users_user_name_keysHandler(cfg),
	}
}
