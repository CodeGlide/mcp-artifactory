...
func Put_v1_teams_team_name_service_users_user_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_service_users_user_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_service_users_user_name",
		mcp.WithDescription("Update a Service User"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_service_users_user_nameHandler(cfg),
	}
}
