...
func Post_v1_teams_team_name_service_usersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/service_users", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_service_usersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_service_users",
		mcp.WithDescription("Create a Service User"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_service_usersHandler(cfg),
	}
}
