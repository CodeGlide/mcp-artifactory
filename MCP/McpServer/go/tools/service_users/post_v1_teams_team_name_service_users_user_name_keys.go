...
func Post_v1_teams_team_name_service_users_user_name_keysHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/service_users/%s/keys", cfg.BaseURL, team_name, user_name)
...
func CreatePost_v1_teams_team_name_service_users_user_name_keysTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_service_users_user_name_keys",
		mcp.WithDescription("Rotate all API keys"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_service_users_user_name_keysHandler(cfg),
	}
}
