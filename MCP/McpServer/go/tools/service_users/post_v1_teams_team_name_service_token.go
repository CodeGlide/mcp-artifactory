...
func Post_v1_teams_team_name_service_tokenHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/service_token", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_service_tokenTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_service_token",
		mcp.WithDescription("Issue a Service User token"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_service_tokenHandler(cfg),
	}
}
