...
func Get_networks_networkid_netflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/netflow", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_netflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_netflow",
		mcp.WithDescription("Return The Net Flow Traffic Reporting Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_netflowHandler(cfg),
	}
}
