...
func Put_networks_networkid_netflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_netflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_netflow",
		mcp.WithDescription("Update The Net Flow Traffic Reporting Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_netflowHandler(cfg),
	}
}
