...
func Get_v1_teams_team_name_groups_group_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_groups_group_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_groups_group_name",
		mcp.WithDescription("Retrieve a Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_groups_group_nameHandler(cfg),
	}
}
