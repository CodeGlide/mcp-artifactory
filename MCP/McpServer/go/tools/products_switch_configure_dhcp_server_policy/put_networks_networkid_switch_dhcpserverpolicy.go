...
func Put_networks_networkid_switch_dhcpserverpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/dhcpServerPolicy", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_switch_dhcpserverpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_dhcpServerPolicy",
		mcp.WithDescription("Update The DHCP Server Policy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_dhcpserverpolicyHandler(cfg),
	}
}
