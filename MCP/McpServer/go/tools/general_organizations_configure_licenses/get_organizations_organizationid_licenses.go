...
func Get_organizations_organizationid_licensesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/licenses", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_licensesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_licenses",
		mcp.WithDescription("List The Licenses For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_licensesHandler(cfg),
	}
}
