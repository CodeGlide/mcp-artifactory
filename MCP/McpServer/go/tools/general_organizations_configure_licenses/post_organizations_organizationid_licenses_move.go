...
func Post_organizations_organizationid_licenses_moveHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/licenses/move", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_licenses_moveTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_licenses_move",
		mcp.WithDescription("Move Licenses To Another Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_licenses_moveHandler(cfg),
	}
}
