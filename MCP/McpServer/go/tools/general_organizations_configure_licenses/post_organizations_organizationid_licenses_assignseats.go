...
func Post_organizations_organizationid_licenses_assignseatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/licenses/assignSeats", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_licenses_assignseatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_licenses_assignSeats",
		mcp.WithDescription("Assign SM Seats To A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_licenses_assignseatsHandler(cfg),
	}
}
