...
func Post_organizations_organizationid_licenses_renewseatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/licenses/renewSeats", cfg.BaseURL, organizationId)
...
func CreatePost_organizations_organizationid_licenses_renewseatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_licenses_renewSeats",
		mcp.WithDescription("Renew SM Seats Of A License"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_licenses_renewseatsHandler(cfg),
	}
}
