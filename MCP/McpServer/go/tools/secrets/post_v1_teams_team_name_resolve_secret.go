...
func Post_v1_teams_team_name_resolve_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resolve_secret", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_resolve_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_resolve_secret",
		mcp.WithDescription("Resolve Secret or Folder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_resolve_secretHandler(cfg),
	}
}
