...
func Get_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_folders_secret_folder_id_itemsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/resource_groups/%s/projects/%s/secret_folders/%s/items%s", cfg.BaseURL, team_name, resource_group_id, project_id, secret_folder_id, queryString)
...
func CreateGet_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_folders_secret_folder_id_itemsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_folders_secret_folder_id_items",
		mcp.WithDescription("List all items in a Secret Folder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_folders_secret_folder_id_itemsHandler(cfg),
	}
}
