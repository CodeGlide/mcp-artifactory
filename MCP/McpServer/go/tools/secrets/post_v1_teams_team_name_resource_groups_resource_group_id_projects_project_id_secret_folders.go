...
func Post_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_foldersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_foldersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_folders",
		mcp.WithDescription("Create a Secret Folder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_resource_groups_resource_group_id_projects_project_id_secret_foldersHandler(cfg),
	}
}
