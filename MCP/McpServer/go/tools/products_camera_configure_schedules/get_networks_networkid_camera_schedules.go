...
func Get_networks_networkid_camera_schedulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/camera/schedules", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_camera_schedulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_camera_schedules",
		mcp.WithDescription("Returns a list of all camera recording schedules."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_camera_schedulesHandler(cfg),
	}
}
