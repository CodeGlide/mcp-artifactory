...
func Get_devices_serial_appliance_dhcp_subnetsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/appliance/dhcp/subnets", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_appliance_dhcp_subnetsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_appliance_dhcp_subnets",
		mcp.WithDescription("Return the DHCP subnet information for an appliance"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_appliance_dhcp_subnetsHandler(cfg),
	}
}
