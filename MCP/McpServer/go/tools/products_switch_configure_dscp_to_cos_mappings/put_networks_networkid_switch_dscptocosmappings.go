...
func Put_networks_networkid_switch_dscptocosmappingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/dscpToCosMappings", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_switch_dscptocosmappingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_dscpToCosMappings",
		mcp.WithDescription("Update The DSCP To Co S Mappings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_dscptocosmappingsHandler(cfg),
	}
}
