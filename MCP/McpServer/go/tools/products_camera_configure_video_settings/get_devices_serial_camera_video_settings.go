...
func Get_devices_serial_camera_video_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/camera/video/settings", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_camera_video_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_camera_video_settings",
		mcp.WithDescription("Returns Video Settings For The Given Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_camera_video_settingsHandler(cfg),
	}
}
