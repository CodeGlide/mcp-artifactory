...
func Put_devices_serial_camera_video_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_devices_serial_camera_video_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_camera_video_settings",
		mcp.WithDescription("Update Video Settings For The Given Camera"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_camera_video_settingsHandler(cfg),
	}
}
