...
func Post_networks_networkid_webhooks_httpserversHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/webhooks/httpServers", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_webhooks_httpserversTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_webhooks_httpServers",
		mcp.WithDescription("Add An HTTP Server To A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_webhooks_httpserversHandler(cfg),
	}
}
