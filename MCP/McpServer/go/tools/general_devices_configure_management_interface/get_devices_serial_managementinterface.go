...
func Get_devices_serial_managementinterfaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/managementInterface", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_managementinterfaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_managementInterface",
		mcp.WithDescription("Return The Management Interface Settings For A Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_managementinterfaceHandler(cfg),
	}
}
