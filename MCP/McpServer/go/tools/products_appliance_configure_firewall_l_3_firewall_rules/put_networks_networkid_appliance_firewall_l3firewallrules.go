...
func Put_networks_networkid_appliance_firewall_l3firewallrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_appliance_firewall_l3firewallrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_firewall_l3FirewallRules",
		mcp.WithDescription("Update The L 3 Firewall Rules Of An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_firewall_l3firewallrulesHandler(cfg),
	}
}
