...
func Get_networks_networkid_appliance_vpn_bgpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkid_appliance_vpn_bgpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_vpn_bgp",
		mcp.WithDescription("Return A Hub BGP Configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_vpn_bgpHandler(cfg),
	}
}
