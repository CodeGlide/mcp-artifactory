...
func Put_networks_networkid_appliance_vpn_bgpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/vpn/bgp", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_vpn_bgpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_vpn_bgp",
		mcp.WithDescription("Update A Hub BGP Configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_vpn_bgpHandler(cfg),
	}
}
