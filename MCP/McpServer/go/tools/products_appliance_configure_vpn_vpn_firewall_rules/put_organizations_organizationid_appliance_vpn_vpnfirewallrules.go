...
func Put_organizations_organizationid_appliance_vpn_vpnfirewallrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_organizations_organizationid_appliance_vpn_vpnfirewallrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_organizations_organizationId_appliance_vpn_vpnFirewallRules",
		mcp.WithDescription("Update The Firewall Rules Of An Organizations Site To Site VPN"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_organizations_organizationid_appliance_vpn_vpnfirewallrulesHandler(cfg),
	}
}
