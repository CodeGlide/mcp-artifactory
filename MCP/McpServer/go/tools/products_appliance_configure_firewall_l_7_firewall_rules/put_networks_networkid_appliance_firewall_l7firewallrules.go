...
func Put_networks_networkid_appliance_firewall_l7firewallrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/firewall/l7FirewallRules", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_firewall_l7firewallrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_firewall_l7FirewallRules",
		mcp.WithDescription("Update The MX L 7 Firewall Rules For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_firewall_l7firewallrulesHandler(cfg),
	}
}
