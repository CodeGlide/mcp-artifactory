...
func Put_networks_networkid_appliance_firewall_onetomanynatrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_appliance_firewall_onetomanynatrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_firewall_oneToManyNatRules",
		mcp.WithDescription("Set The 1 Many NAT Mapping Rules For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_firewall_onetomanynatrulesHandler(cfg),
	}
}
