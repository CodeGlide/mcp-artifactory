...
func Post_networks_networkid_switch_accesspoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/accessPolicies", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_switch_accesspoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_accessPolicies",
		mcp.WithDescription("Create An Access Policy For A Switch Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_accesspoliciesHandler(cfg),
	}
}
