...
func Get_networks_networkid_appliance_singlelanHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/singleLan", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_appliance_singlelanTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_singleLan",
		mcp.WithDescription("Return Single LAN Configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_singlelanHandler(cfg),
	}
}
