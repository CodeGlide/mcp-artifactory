...
func Get_networks_networkid_wireless_ssidsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/ssids", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_ssidsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_ssids",
		mcp.WithDescription("List The MR SSI Ds In A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_ssidsHandler(cfg),
	}
}
