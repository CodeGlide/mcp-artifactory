...
func Get_networks_networkid_wireless_latencystatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/latencyStats", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_latencystatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_latencyStats",
		mcp.WithDescription("Aggregated Latency Info For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_latencystatsHandler(cfg),
	}
}
