...
func Get_devices_serial_wireless_latencystatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/wireless/latencyStats", cfg.BaseURL, serial)
...
func CreateGet_devices_serial_wireless_latencystatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_wireless_latencyStats",
		mcp.WithDescription("Aggregated Latency Info For A Given AP On This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_wireless_latencystatsHandler(cfg),
	}
}
