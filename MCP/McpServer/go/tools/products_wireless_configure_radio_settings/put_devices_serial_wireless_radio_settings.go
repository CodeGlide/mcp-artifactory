...
func Put_devices_serial_wireless_radio_settingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/wireless/radio/settings", cfg.BaseURL, serial)
...
func CreatePut_devices_serial_wireless_radio_settingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_wireless_radio_settings",
		mcp.WithDescription("Update The Radio Settings Of A Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_wireless_radio_settingsHandler(cfg),
	}
}
