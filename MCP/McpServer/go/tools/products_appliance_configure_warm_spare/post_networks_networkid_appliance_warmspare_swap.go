...
func Post_networks_networkid_appliance_warmspare_swapHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/warmSpare/swap", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_appliance_warmspare_swapTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_appliance_warmSpare_swap",
		mcp.WithDescription("Swap MX Primary And Warm Spare Appliances"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_appliance_warmspare_swapHandler(cfg),
	}
}
