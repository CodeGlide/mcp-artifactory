...
func Put_networks_networkid_appliance_warmspareHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/warmSpare", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_warmspareTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_warmSpare",
		mcp.WithDescription("Update MX Warm Spare Settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_warmspareHandler(cfg),
	}
}
