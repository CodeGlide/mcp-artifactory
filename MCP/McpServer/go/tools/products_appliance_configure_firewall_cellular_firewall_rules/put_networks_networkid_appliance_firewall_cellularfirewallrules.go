...
func Put_networks_networkid_appliance_firewall_cellularfirewallrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_appliance_firewall_cellularfirewallrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_firewall_cellularFirewallRules",
		mcp.WithDescription("Update The Cellular Firewall Rules Of An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_firewall_cellularfirewallrulesHandler(cfg),
	}
}
