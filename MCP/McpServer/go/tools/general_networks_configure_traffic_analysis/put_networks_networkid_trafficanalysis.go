...
func Put_networks_networkid_trafficanalysisHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/trafficAnalysis", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_trafficanalysisTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_trafficAnalysis",
		mcp.WithDescription("Update The Traffic Analysis Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_trafficanalysisHandler(cfg),
	}
}
