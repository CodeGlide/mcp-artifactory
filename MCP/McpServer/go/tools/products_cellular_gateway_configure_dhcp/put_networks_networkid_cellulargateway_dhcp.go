...
func Put_networks_networkid_cellulargateway_dhcpHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/cellularGateway/dhcp", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_cellulargateway_dhcpTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_cellularGateway_dhcp",
		mcp.WithDescription("Update Common DHCP Settings Of M Gs"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_cellulargateway_dhcpHandler(cfg),
	}
}
