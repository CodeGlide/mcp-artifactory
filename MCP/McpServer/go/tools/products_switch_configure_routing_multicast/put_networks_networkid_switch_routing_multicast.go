...
func Put_networks_networkid_switch_routing_multicastHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_switch_routing_multicastTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_switch_routing_multicast",
		mcp.WithDescription("Update Multicast Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_switch_routing_multicastHandler(cfg),
	}
}
