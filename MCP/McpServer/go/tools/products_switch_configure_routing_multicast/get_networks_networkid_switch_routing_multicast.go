...
func Get_networks_networkid_switch_routing_multicastHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/routing/multicast", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_switch_routing_multicastTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_routing_multicast",
		mcp.WithDescription("Return Multicast Settings For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_routing_multicastHandler(cfg),
	}
}
