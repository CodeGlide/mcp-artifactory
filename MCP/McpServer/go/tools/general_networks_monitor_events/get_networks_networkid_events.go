...
func Get_networks_networkid_eventsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/events", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_eventsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_events",
		mcp.WithDescription("List The Events For The Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_eventsHandler(cfg),
	}
}
