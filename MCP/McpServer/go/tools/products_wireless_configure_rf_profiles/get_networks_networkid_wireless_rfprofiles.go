...
func Get_networks_networkid_wireless_rfprofilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/rfProfiles", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_rfprofilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_rfProfiles",
		mcp.WithDescription("List The Non Basic RF Profiles For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_rfprofilesHandler(cfg),
	}
}
