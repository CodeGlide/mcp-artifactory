...
func Post_networks_networkid_wireless_rfprofilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_wireless_rfprofilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_wireless_rfProfiles",
		mcp.WithDescription("Creates New RF Profile For This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_wireless_rfprofilesHandler(cfg),
	}
}
