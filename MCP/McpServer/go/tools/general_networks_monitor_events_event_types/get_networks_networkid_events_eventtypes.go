...
func Get_networks_networkid_events_eventtypesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/events/eventTypes", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_events_eventtypesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_events_eventTypes",
		mcp.WithDescription("List the event type to human-readable description"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_events_eventtypesHandler(cfg),
	}
}
