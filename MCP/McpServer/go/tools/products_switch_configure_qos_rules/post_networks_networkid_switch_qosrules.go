...
func Post_networks_networkid_switch_qosrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/switch/qosRules", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_switch_qosrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_switch_qosRules",
		mcp.WithDescription("Add A Quality Of Service Rule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_switch_qosrulesHandler(cfg),
	}
}
