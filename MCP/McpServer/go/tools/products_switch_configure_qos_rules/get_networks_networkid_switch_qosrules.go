...
func Get_networks_networkid_switch_qosrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkid_switch_qosrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_switch_qosRules",
		mcp.WithDescription("List Quality Of Service Rules"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_switch_qosrulesHandler(cfg),
	}
}
