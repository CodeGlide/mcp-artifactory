...
func Get_networks_networkid_clients_overviewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/clients/overview", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_clients_overviewTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_clients_overview",
		mcp.WithDescription("Return overview statistics for network clients"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_clients_overviewHandler(cfg),
	}
}
