...
func Get_networks_networkid_wireless_billingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/billing", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_wireless_billingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_billing",
		mcp.WithDescription("Return The Billing Settings Of This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_billingHandler(cfg),
	}
}
