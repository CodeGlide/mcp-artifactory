...
func Put_networks_networkid_wireless_billingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_networks_networkid_wireless_billingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_wireless_billing",
		mcp.WithDescription("Update The Billing Settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_wireless_billingHandler(cfg),
	}
}
