...
func Get_networks_networkid_grouppoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/groupPolicies", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_grouppoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_groupPolicies",
		mcp.WithDescription("List The Group Policies In A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_grouppoliciesHandler(cfg),
	}
}
