...
func Post_networks_networkid_grouppoliciesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_networks_networkid_grouppoliciesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_groupPolicies",
		mcp.WithDescription("Create A Group Policy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_grouppoliciesHandler(cfg),
	}
}
