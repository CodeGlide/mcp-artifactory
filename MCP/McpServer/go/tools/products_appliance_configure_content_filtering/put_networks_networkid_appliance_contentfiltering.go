...
func Put_networks_networkid_appliance_contentfilteringHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/contentFiltering", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_appliance_contentfilteringTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_appliance_contentFiltering",
		mcp.WithDescription("Update The Content Filtering Settings For An MX Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_appliance_contentfilteringHandler(cfg),
	}
}
