...
func Put_networks_networkid_syslogserversHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/syslogServers", cfg.BaseURL, networkId)
...
func CreatePut_networks_networkid_syslogserversTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_networks_networkId_syslogServers",
		mcp.WithDescription("Update The Syslog Servers For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_networks_networkid_syslogserversHandler(cfg),
	}
}
