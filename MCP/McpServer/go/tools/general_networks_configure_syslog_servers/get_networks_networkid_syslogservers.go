...
func Get_networks_networkid_syslogserversHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_networks_networkid_syslogserversTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_syslogServers",
		mcp.WithDescription("List The Syslog Servers For A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_syslogserversHandler(cfg),
	}
}
