...
func Get_networks_networkid_appliance_staticroutesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/appliance/staticRoutes", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_appliance_staticroutesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_appliance_staticRoutes",
		mcp.WithDescription("List The Static Routes For An MX Or Teleworker Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_appliance_staticroutesHandler(cfg),
	}
}
