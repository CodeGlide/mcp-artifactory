...
func Get_v1_teams_team_name_groups_group_name_attributes_attribute_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_groups_group_name_attributes_attribute_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_groups_group_name_attributes_attribute_id",
		mcp.WithDescription("Retrieve a Group Attribute"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_groups_group_name_attributes_attribute_idHandler(cfg),
	}
}
