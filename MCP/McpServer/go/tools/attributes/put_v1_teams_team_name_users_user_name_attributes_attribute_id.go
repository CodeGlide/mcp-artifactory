...
func Put_v1_teams_team_name_users_user_name_attributes_attribute_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_v1_teams_team_name_users_user_name_attributes_attribute_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_teams_team_name_users_user_name_attributes_attribute_id",
		mcp.WithDescription("Update a User Attribute"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_v1_teams_team_name_users_user_name_attributes_attribute_idHandler(cfg),
	}
}
