...
func Get_v1_teams_team_name_users_user_name_attributes_attribute_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/users/%s/attributes/%s", cfg.BaseURL, team_name, user_name, attribute_id)
...
func CreateGet_v1_teams_team_name_users_user_name_attributes_attribute_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_users_user_name_attributes_attribute_id",
		mcp.WithDescription("Retrieve a User Attribute"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_users_user_name_attributes_attribute_idHandler(cfg),
	}
}
