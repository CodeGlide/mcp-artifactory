...
func Get_networks_networkid_wireless_clients_clientid_connectionstatsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/wireless/clients/%s/connectionStats", cfg.BaseURL, networkId, clientId)
...
func CreateGet_networks_networkid_wireless_clients_clientid_connectionstatsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_wireless_clients_clientId_connectionStats",
		mcp.WithDescription("Aggregated Connectivity Info For A Given Client On This Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_wireless_clients_clientid_connectionstatsHandler(cfg),
	}
}
