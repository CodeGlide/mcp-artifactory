...
func Post_networks_networkid_devices_removeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/devices/remove", cfg.BaseURL, networkId)
...
func CreatePost_networks_networkid_devices_removeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_networks_networkId_devices_remove",
		mcp.WithDescription("Remove A Single Device"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_networks_networkid_devices_removeHandler(cfg),
	}
}
