...
func Get_networks_networkid_devicesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/networks/%s/devices", cfg.BaseURL, networkId)
...
func CreateGet_networks_networkid_devicesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_networks_networkId_devices",
		mcp.WithDescription("List The Devices In A Network"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_networks_networkid_devicesHandler(cfg),
	}
}
