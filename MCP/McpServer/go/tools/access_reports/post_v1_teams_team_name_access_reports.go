...
func Post_v1_teams_team_name_access_reportsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/teams/%s/access_reports", cfg.BaseURL, team_name)
...
func CreatePost_v1_teams_team_name_access_reportsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_teams_team_name_access_reports",
		mcp.WithDescription("Create an Access Report"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_v1_teams_team_name_access_reportsHandler(cfg),
	}
}
