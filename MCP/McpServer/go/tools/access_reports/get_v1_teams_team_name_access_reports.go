...
func Get_v1_teams_team_name_access_reportsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_v1_teams_team_name_access_reportsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_teams_team_name_access_reports",
		mcp.WithDescription("List all Access Reports"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v1_teams_team_name_access_reportsHandler(cfg),
	}
}
