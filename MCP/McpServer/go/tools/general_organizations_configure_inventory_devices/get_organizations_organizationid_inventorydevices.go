...
func Get_organizations_organizationid_inventorydevicesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/inventoryDevices", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_inventorydevicesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_inventoryDevices",
		mcp.WithDescription("Return The Device Inventory For An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_inventorydevicesHandler(cfg),
	}
}
