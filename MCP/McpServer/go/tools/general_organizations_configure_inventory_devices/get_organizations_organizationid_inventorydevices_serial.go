...
func Get_organizations_organizationid_inventorydevices_serialHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/inventoryDevices/%s", cfg.BaseURL, organizationId, serial)
...
func CreateGet_organizations_organizationid_inventorydevices_serialTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_inventoryDevices_serial",
		mcp.WithDescription("Return A Single Device From The Inventory Of An Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_inventorydevices_serialHandler(cfg),
	}
}
