...
func Get_devices_serial_cellulargateway_lanHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_devices_serial_cellulargateway_lanTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_devices_serial_cellularGateway_lan",
		mcp.WithDescription("Show The LAN Settings Of A MG"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_devices_serial_cellulargateway_lanHandler(cfg),
	}
}
