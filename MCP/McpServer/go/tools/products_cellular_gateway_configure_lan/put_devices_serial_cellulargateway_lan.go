...
func Put_devices_serial_cellulargateway_lanHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/devices/%s/cellularGateway/lan", cfg.BaseURL, serial)
...
func CreatePut_devices_serial_cellulargateway_lanTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_devices_serial_cellularGateway_lan",
		mcp.WithDescription("Update The LAN Settings For A Single MG"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_devices_serial_cellulargateway_lanHandler(cfg),
	}
}
