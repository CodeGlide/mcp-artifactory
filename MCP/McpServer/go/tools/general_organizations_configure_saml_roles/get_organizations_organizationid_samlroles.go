...
func Get_organizations_organizationid_samlrolesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/organizations/%s/samlRoles", cfg.BaseURL, organizationId)
...
func CreateGet_organizations_organizationid_samlrolesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_organizations_organizationId_samlRoles",
		mcp.WithDescription("List The SAML Roles For This Organization"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_organizations_organizationid_samlrolesHandler(cfg),
	}
}
