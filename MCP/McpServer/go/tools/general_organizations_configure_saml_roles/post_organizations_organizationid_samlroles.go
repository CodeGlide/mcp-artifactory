...
func Post_organizations_organizationid_samlrolesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_organizations_organizationid_samlrolesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_organizations_organizationId_samlRoles",
		mcp.WithDescription("Create A SAML Role"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_organizations_organizationid_samlrolesHandler(cfg),
	}
}
