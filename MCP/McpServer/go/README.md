# Meraki Dashboard API - v1.9.0 MCP Server

This MCP (Model Content Protocol) server provides access to Meraki Dashboard API - v1.9.0 API functionality through HTTP, HTTPS, and STDIO transport modes.
