# Square Connect API MCP Server

This MCP (Model Content Protocol) server provides access to Square Connect API API functionality through HTTP, HTTPS, and STDIO transport modes.
