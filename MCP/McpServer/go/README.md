# NOWPayments API MCP Server

This MCP (Model Content Protocol) server provides access to NOWPayments API API functionality through HTTP, HTTPS, and STDIO transport modes.
