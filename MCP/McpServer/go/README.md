# Jira Integration API MCP Server

This MCP (Model Content Protocol) server provides access to Jira Integration API API functionality through HTTP, HTTPS, and STDIO transport modes.
