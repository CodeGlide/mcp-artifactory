# Okta Privileged Access MCP Server

This MCP (Model Content Protocol) server provides access to Okta Privileged Access API functionality through HTTP, HTTPS, and STDIO transport modes.
