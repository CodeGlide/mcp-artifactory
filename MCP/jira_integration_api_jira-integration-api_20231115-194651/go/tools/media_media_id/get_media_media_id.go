...
func Get_media_media_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/media/%s", cfg.BaseURL, media_id)
...
func CreateGet_media_media_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_media_media-id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_media_media_idHandler(cfg),
	}
}
