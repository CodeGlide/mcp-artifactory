...
func Issues_add_labelsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateIssues_add_labelsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_issues_issue_number_labels",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Issues_add_labelsHandler(cfg),
	}
}
