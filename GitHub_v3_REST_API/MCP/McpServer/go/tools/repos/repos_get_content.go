...
func Repos_get_contentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_get_contentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_contents_path",
		mcp.WithDescription("Get repository content"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_get_contentHandler(cfg),
	}
}
